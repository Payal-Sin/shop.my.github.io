...
if(!isset($_SESSION['username'])){
	header('location:productdetail1.php');
}
?>
...
<div class="row">
<div class="col-2">
<img class="image" src="kurta2.jpg" id="ProductImg">

<div class="small-img-row">

<div class="small-img-col">
  <img class="img" src="kurta3.jpg" width="50%" height="165px" onclick="myFunction(this)">
</div>
<div class="small-img-col">
<img src="kurta6.jpg" width="50%" height="165px" onclick="myFunction(this)"  >   
</div>

<div class="small-img-col">
  <img class="imi" src="kurta4.jpg" width="50%" onclick="myFunction(this)">
</div>

<div class="small-img-col">
  <img class="im"src="kurta5.jpg" width="50%" onclick="myFunction(this)">
</div>
