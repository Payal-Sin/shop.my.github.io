...
<div class="container">
  ...
  <nav>
  <ul>
  <li><a class="under1" href="#" onClick="showcustom()">MEN</a></li>
  <li><a class="under2" href="#" onClick="showcustom()">WOMEN</a></li>
  <li><a class="under3" href="#" onClick="showcustom()">KIDS</a></li>
  <li><a class="under4" href="#" onClick="showcustom()">HOME & LIVING</a></li>
  <li><a class="under5" href="#" onClick="showcustom()">ESSENTIALS</a></li>
  </ul>
  </nav>
  </div>
  <input class="search" type="search" placeholder="search.....">
  <img class="icon" src="searchicon.jpg">
  <a href="signin.php" class="btn1" >LogIn</a>
...
<div class="best">
<img class="deals" src="home image 2.jpg">Casual Shoes<br>Under<b> <span class="rate">Rs.599</span></b>
</div>
<div class="best">
<img class="deals" src="image 5.jpg">Dresses<br> Under <b><span class="rate">Rs.899</span></b>
</div>
<div class="best">
<img class="deals" src="home image 3.jpg">Watches <br> Under <b><span class="rate">Rs. 600</span></b>
</div>
<div class="best">
<img class="deals" src="mshirt.jpg">Shirts <br> Under <b><span class="rate">Rs. 799</span></b>
</div>
<div class="best">
<img class="deals" src="image 6.jpg">Bags<br> Under<b><span class="rate"> Rs. 399</span></b>
</div>
<div class="best">
<img class="deals" src="home image 4.jpg">Bracelets<br>Under<b><span class="rate"> Rs.299</span></b>
</div>
</div>
</center>
<!------------ Sale--------------->
