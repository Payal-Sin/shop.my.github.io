                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><button class="btn btn-sm btn-danger" onclick="return confirm('Are you sure want to remove this product?')?window.location.href='cartAction.php?action=removeCartItem&id=<?php echo $item["rowid"]; ?>':false;"><i class="itrash"></i>Remove </button> </td>
                            </tr>
                            <?php } }else{ ?>
