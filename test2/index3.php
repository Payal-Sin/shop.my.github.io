  ...
  <div class="container-new">
    ...
    <div class="row col-lg-12">
        ...
        <div class="card col-lg-4">
         ...
         <a href="cartAction3.php?action=addToCart&id=<?php echo $row["id"]; ?>" class="btn btn-primary"> <button type="submit" class="buy">Add to Cart</button></a>
            </div>
        </div>
        <?php } }else{ ?>
...
<div class="row">
<div class="col-2">
<img class="image" src="IMG_20200926_113918.jpg" id="ProductImg">

<div class="small-img-row">

<div class="small-img-col">
  <img class="img" src="IMG_20200926_113918.jpg" width="50%" height="165px" onclick="myFunction(this)">
</div>
<div class="small-img-col">
<img src="IMG_20200926_113930.jpg" width="50%" height="165px" onclick="myFunction(this)"  >   
</div>

<div class="small-img-col">
  <img class="imi" src="IMG_20200926_113954.jpg" width="50%" onclick="myFunction(this)">
</div>

<div class="small-img-col">
  <img class="im"src="IMG_20200926_114008.jpg" width="50%" onclick="myFunction(this)">
</div>
...
<!--<div class="col-2">-->
<div class="nav">
 <h1 class="nam">Campus Surta</h1>
 <h2 class="name1">Navy Blue Colourblocked Hooded Sweatshirt</h2>
 <h4 class="name2">&#8377; 815   <span class="span"> &#8377; 1599</span>  <span class="span1">(49% OFF)</span></h4>
 <select >
...
<!---- <a href="optional2.php" class="btn">Add to Cart</a>------->
 ...
 <p>This Sweatshirt is made of 100% Cotton, the cotton fabric of hoodie spells pure comfort and warmth.</p>
</p>
<h3>Size & Fit</h3>
...
<p>100% cotton<br>
Machine-Wash</p>
<h3>Product Code: <span class="product-code"> 8529000</span></h3>
...
<div class="related">
<img class="product" src="IMG_20200911_125417.jpg"><p class="rel"><b>Vishudh</b><br>
<span class="s1">Black T-shirt</span><br><b>Rs.1139</b></br></p>
</div>

<div class="related">
<img class="product"  src="mhooded.jpg"><b><p class="rel">Elevate</b><br>
<span class="s1">Navy Blue Hooded T-shirt</span><br><b>Rs.999</b></p>
</div>

<div class="related">
<img class="product" src="mprintedshirt.jpg"><p class="rel"><b>Huetrap</b><br>
<span class="s1">Men Printed Casual Shirt</span><br><b>Rs.637</b></br></p>
</div>

<div class="related">
<img class="product" src="morangetshirt.jpg"><p class="rel"><b>INVICTUS</b><br>
<span class="s1">Round Neck Orange T-shirt</span><br><b>Rs.799</b></br></p>
</div>

<div class="related">
<img class="product" src="mstriped.jpg"><p class="rel"><b>Classic Polo</b><br>
<span class="s1">Striped Casual Spread Shirt</span><br><b>Rs.799</b></br></p>
</div> 

<div class="related">
<img class="product" src="mtshirt.jpg"><p class="rel"><b>AKS</b><br>
<span class="s1">Printed T-shirt</span><br><b>Rs.835</b></br></p>
</div>
